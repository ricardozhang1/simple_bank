...
func createOneTransfer(t *testing.T, account1, account2 Account) Transfer {
...
func TestCreateTransfers(t *testing.T) {
	...
	createOneTransfer(t, account1, account2)
}

func TestGetTransfers(t *testing.T) {
	account1 := createRandomAccount(t)
	account2 := createRandomAccount(t)
	transfer1 := createOneTransfer(t, account1, account2)
